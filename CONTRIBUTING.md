# Contributing to cloudflare-analytics-cli

Thank you for your interest in contributing to cloudflare-analytics-cli! This document provides guidelines and
instructions for contributing to the project.

## 🙏 Welcome!

cloudflare-analytics-cli is a CLI tool for managing Zoom meetings via Server-to-Server OAuth. We welcome
...
- ✨ **Adding new features** - Expand cloudflare-analytics-cli's capabilities (discuss first!)
...
git clone https://github.com/YOUR_USERNAME/cloudflare-analytics-cli.git
...
- 💬 **Questions** - Open a [GitHub Discussion](https://github.com/tackeyy/cloudflare-analytics-cli/discussions)
- 🐛 **Bug Reports** - Open an [Issue](https://github.com/tackeyy/cloudflare-analytics-cli/issues/new?template=bug_report.yml)
- 💡 **Feature Requests** - Open an [Issue](https://github.com/tackeyy/cloudflare-analytics-cli/issues/new?template=feature_request.yml)
- ❓ **General Questions** - Open an [Issue](https://github.com/tackeyy/cloudflare-analytics-cli/issues/new?template=question.yml)
...
Thank you for contributing to cloudflare-analytics-cli! Your efforts help make this tool better for everyone.
