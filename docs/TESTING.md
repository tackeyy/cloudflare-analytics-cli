...
cloudflare-analytics-cli uses [Vitest](https://vitest.dev/) as its testing framework. All code contributions must include comprehensive tests.
...
2. Ask in [GitHub Discussions](https://github.com/tackeyy/cloudflare-analytics-cli/discussions)
